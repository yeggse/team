...
<body>
	...
	<div id="app" style="width: 2483.02px; padding-top: 120px;"
		...
		<div>
			...
			<button
				onClick="location.href='http://127.0.0.1:8080/reviewwrite.do'">리뷰쓰기</button>
			...
			<button
				onClick="location.href='http://127.0.0.1:8080/menumanagementbusiness.do'">메뉴관리</button>
			<button
				onClick="location.href='http://127.0.0.1:8080/menuaddbusiness.do'">메뉴추가</button>
			<button
				onClick="location.href='http://127.0.0.1:8080/menuaddbusiness2.do'">추가</button>
		</div>
		<div class="div0">
